...
from app.schemas.borrow_history import BorrowHistoryCreateV1, BorrowHistoryUpdateV1, Response

borrow_history_router_v1 = APIRouter()


@borrow_history_router_v1.get(
    '/books/borrow_history/',
    status_code=200,
...
async def get_borrow_history(borrow_history_id: UUID):
    pass
...
async def create_borrow_history(borrow_history_create: BorrowHistoryCreateV1):
    pass
...
async def delete_borrow_history(borrow_history_id: UUID):
    pass
